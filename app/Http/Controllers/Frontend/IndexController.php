...
class IndexController extends Controller
{
    public function index(){
        ...
        'skip_category_1','skip_product_1','skip_brand_2','skip_brand_product_2'));
    }
    ...
    public function ProductDetails($id,$slug){
        ...
        'product_color_en','product_color_hin','product_size_hin','product_size_en','relatedProduct','hot_deals'));
    }

    public function TagWiseProduct($tag){
        $products  = Product::where('status',1)->where('product_tags_en',$tag)->where(
            'product_tags_hin',$tag)->orderBy('id','DESC')->paginate(3);
        $categories = Category::orderBy('category_name_en','ASC')->get();
    ...
    public function ProductViewAjax($id){
        $product = Product::with('category','brand')->findOrFail($id);      //Model RelationShip
        ...
        return response()->json(array(                                     ///Need Return Response AS JSON Format
            'product' => $product,
            'color' => $product_color,
            'size' => $product_size,
        ));
