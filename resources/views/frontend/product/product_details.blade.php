...
<div class="row">
	...
	<div class="form-group">
		...
		<select class="form-control unicase-form-control selectpicker" id="color">
			<option selected="" disables="">--Select options--</option>
...
<!-- //////////////////////////////////////End  Add Color and Size////////////////////// -->
				...
				<div class="product-tabs inner-bottom-xs  wow fadeInUp">
					<div class="row">
                        ...
                        url('upload/user_images/'.$item->user->profile_photo_path) : url('upload/no_image.jpg') }}" width="40px;" height="40px;" ><b>{{ $item->user->name }}</b>
													</div>
										...
										<div class="product-add-review">
											...
											@guest
											<p><b>For Add Product Review You need to Login First <a href="{{ route('login') }}">Login</a></b></p>
											@else
